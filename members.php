...
footer.footer {
  ...
  <button class="btn btn-custom disapprove-btn" data-id="<?php echo $row['id']; ?>" data-status="Remove">Remove</button>
</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-2">
            ...
            <input type="text" name="password" id="form_password" class="form-control" required>
          </div>
        </div>
    ...
    button.addEventListener('click', function () {
      ...
      .then(data => {
        if (data === 'success') {
          ...
          this.closest('.form-container').remove(); // remove the form from page
        } else {
