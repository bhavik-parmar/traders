...
// Fetch total posts
$total_posts = $conn->query("SELECT COUNT(*) AS total FROM requirement")->fetch_assoc()['total'];

// Fetch pending members
$pending_members = $conn->query("SELECT COUNT(*) AS total FROM members WHERE status = 'pending'")->fetch_assoc()['total'];

// Fetch pending posts
$pending_posts = $conn->query("SELECT COUNT(*) AS total FROM requirement WHERE status = 'pending'")->fetch_assoc()['total'];
...
<html lang="en">
  ...
  <div class="col-md-3 mb-4">
    <div class="card card-light-blue">
      <div class="card-body">
        <p class="mb-4">New Membership Requests</p>
        <p class="fs-30 mb-2"><?= $pending_members ?></p>
      </div>
    </div>
  </div>
  <div class="col-md-3 mb-4">
    <div class="card card-light-danger">
      <div class="card-body">
        <p class="mb-4">New Post Requests</p>
        <p class="fs-30 mb-2"><?= $pending_posts ?></p>
      </div>
    </div>
  </div>
</div>
